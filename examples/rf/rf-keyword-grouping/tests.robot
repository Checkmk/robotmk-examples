*** Settings ***
Documentation    This is a test suite to demonstrate grouping keywords in Robot Framework.
...  Robotmk treats them like normal keywords; they can also be discovered. 
